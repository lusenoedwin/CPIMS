...
public class addnewchildhome extends AppCompatActivity {
    Spinner sex,tribe,religion,subcounty,ward,relationship;String text = "";
    EditText childname, dob,residence,chldhomereg, chldhome,birthreg,country,caregivername,caregiverphone,cstatement,caregiverid;
    Button regnewchild;
    boolean valid = true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addnewchildhome);
        ...
        regnewchild = findViewById(R.id.regnewchild);
        chldhomereg=findViewById(R.id.chldhomereg);
        chldhome=findViewById(R.id.chldhome);


        final FirebaseFirestore firebaseFirestore;
        final DocumentReference ref;
        firebaseFirestore = FirebaseFirestore.getInstance();
        ref = firebaseFirestore.collection("childrenhomes").document();


        regnewchild.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                checkField(childname);
                checkField(dob);
                checkField(birthreg);
                checkField(country);
                checkField(caregivername);
                checkField(caregiverphone);
                checkField(residence);
                checkField(caregiverid);
                checkField(cstatement);
                checkField(chldhomereg);
                checkField(chldhome);
                ...
                if (valid){
                    ...
                    ref.get().addOnSuccessListener((DocumentSnapshot documentSnapshot) -> {
                        ...
                        {
                            Toast.makeText(addnewchildhome.this, "Sorry,this case exists", Toast.LENGTH_SHORT).show();
                        } else {
                            ...
                            reg_entry.put("childhome",chldhome.getText().toString());
                            reg_entry.put("childhomereg", chldhomereg.getText().toString());
                            ...
                            firebaseFirestore.collection("childrenhomes")
                                    .add(reg_entry)
                                    .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                        ...
                                        public void onSuccess(DocumentReference documentReference) {
                                            ...
                                            tv.setText("Child Successfully registered");
...
//                                    Intent intent= new Intent(addnewchildhome.this,AdminNavActivity.class);
