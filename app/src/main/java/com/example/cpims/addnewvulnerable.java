...
public class addnewvulnerable extends AppCompatActivity {
    ...
    Button regvulnerablecase;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_addnewvulnerable);
        ...
        regvulnerablecase = findViewById(R.id.regvulnerablecase);

        final FirebaseFirestore firebaseFirestore;
        final DocumentReference ref;
        firebaseFirestore = FirebaseFirestore.getInstance();
        ref = firebaseFirestore.collection("vulnerable").document();





        regvulnerablecase.setOnClickListener((View view) -> {
            if(childname.getText().toString().equals("")) {
                Toast.makeText(addnewvulnerable.this, "Please enter  full names", Toast.LENGTH_SHORT).show();

            }else if(dob.getText().toString().equals("")) {
                Toast.makeText(addnewvulnerable.this, "Please enter dob", Toast.LENGTH_SHORT).show();

            }else if(birthreg.getText().toString().equals("")){
                Toast.makeText(addnewvulnerable.this, "Please enter birth reg no:", Toast.LENGTH_SHORT).show();

            }else if(country.getText().toString().equals("")) {
                Toast.makeText(addnewvulnerable.this, "Please enter country", Toast.LENGTH_SHORT).show();

            }else if(residence.getText().toString().equals("")) {
                Toast.makeText(addnewvulnerable.this, "Please enter place of residence", Toast.LENGTH_SHORT).show();

            }else if(caregivername.getText().toString().equals("")) {
                Toast.makeText(addnewvulnerable.this, "Please enter caregiver name", Toast.LENGTH_SHORT).show();

            }else if(caregiverphone.getText().toString().equals("")) {
                Toast.makeText(addnewvulnerable.this, "Please enter caregiver phone", Toast.LENGTH_SHORT).show();
            }else if(caregiverid.getText().toString().equals("")) {
                Toast.makeText(addnewvulnerable.this, "Please enter caregiver ID no:", Toast.LENGTH_SHORT).show();
            }else if(cstatement.getText().toString().equals("")) {
                Toast.makeText(addnewvulnerable.this, "Please enter case statement", Toast.LENGTH_SHORT).show();
                ...
                ref.get().addOnSuccessListener((DocumentSnapshot documentSnapshot) -> {
                    ...
                    {
                        Toast.makeText(addnewvulnerable.this, "Sorry,this case exists", Toast.LENGTH_SHORT).show();
                    } else {
...
//                              String myId = ref.getId();
                        firebaseFirestore.collection("vulnerable")
                                .add(reg_entry)
...
//                                        Toast.makeText(addnewdefiledcase.this, " Case Successfully registered", Toast.LENGTH_LONG).show();
                                        Intent intent= new Intent(addnewvulnerable.this,AdminNavActivity.class);
