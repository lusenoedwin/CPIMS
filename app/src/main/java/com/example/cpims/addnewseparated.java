...
public class addnewseparated extends AppCompatActivity {
    ...
    Button regseparatedcase;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_addnewseparated);
        ...
        regseparatedcase = findViewById(R.id.regseparatedcase);

        final FirebaseFirestore firebaseFirestore;
        final DocumentReference ref;
        firebaseFirestore = FirebaseFirestore.getInstance();
        ref = firebaseFirestore.collection("separated").document();





        regseparatedcase.setOnClickListener((View view) -> {
            if(childname.getText().toString().equals("")) {
                Toast.makeText(addnewseparated.this, "Please enter  child name", Toast.LENGTH_SHORT).show();

            }else if(dob.getText().toString().equals("")) {
                Toast.makeText(addnewseparated.this, "Please enter dob", Toast.LENGTH_SHORT).show();

            }else if(birthreg.getText().toString().equals("")){
                Toast.makeText(addnewseparated.this, "Please enter Birth reg no:", Toast.LENGTH_SHORT).show();

            }else if(country.getText().toString().equals("")) {
                Toast.makeText(addnewseparated.this, "Please enter country", Toast.LENGTH_SHORT).show();

            }else if(residence.getText().toString().equals("")) {
                Toast.makeText(addnewseparated.this, "Please enter place of residence", Toast.LENGTH_SHORT).show();
            }else if(caregivername.getText().toString().equals("")) {
                Toast.makeText(addnewseparated.this, "Please enter caregiver name", Toast.LENGTH_SHORT).show();
            }else if(caregiverphone.getText().toString().equals("")) {
                Toast.makeText(addnewseparated.this, "Please enter caregiver phone", Toast.LENGTH_SHORT).show();
            }else if(caregiverid.getText().toString().equals("")) {
                Toast.makeText(addnewseparated.this, "Please enter caregiver ID", Toast.LENGTH_SHORT).show();
            }else if(cstatement.getText().toString().equals("")) {
                Toast.makeText(addnewseparated.this, "Please enter case statement", Toast.LENGTH_SHORT).show();
                ...
                ref.get().addOnSuccessListener((DocumentSnapshot documentSnapshot) -> {
                    ...
                    {
                        Toast.makeText(addnewseparated.this, "Sorry,this case exists", Toast.LENGTH_SHORT).show();
                    } else {
...
//                              String myId = ref.getId();
                        firebaseFirestore.collection("separated")
                                .add(reg_entry)
...
//                                        Toast.makeText(addnewdefiledcase.this, " Case Successfully registered", Toast.LENGTH_LONG).show();
                                        Intent intent= new Intent(addnewseparated.this,AdminNavActivity.class);
