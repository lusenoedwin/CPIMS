...
public class addnewschdropped extends AppCompatActivity {
    Spinner sex,tribe,religion,subcounty,ward,relationship;String text = "";
    EditText fullname, dateofbirth, nameofschoolattended, highestformgradeclassattended, lastgrademarksattained,placeofresidence, reasonfordroppingoutofschool,birthreg,country,caregivername,caregiverphone,cstatement,caregiverid;
    Button regnewschooldropoutcase;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_addnewschdropped);
        ...
        nameofschoolattended=findViewById(R.id.schoolname);
        highestformgradeclassattended=findViewById(R.id.classlevel);
        ...
        reasonfordroppingoutofschool=findViewById(R.id.reasonfordropping);
        lastgrademarksattained=findViewById(R.id.gradeattained);
        regnewschooldropoutcase=findViewById(R.id.regnewschooldropoutcase);

        final FirebaseFirestore firebaseFirestore;
        final DocumentReference ref;
        firebaseFirestore = FirebaseFirestore.getInstance();
        ref = firebaseFirestore.collection("schooldropped").document();





        regnewschooldropoutcase.setOnClickListener((View view) -> {
            if(fullname.getText().toString().equals("")) {
                Toast.makeText(addnewschdropped.this, "Please enter  full names", Toast.LENGTH_SHORT).show();

            }else if(dateofbirth.getText().toString().equals("")) {
                Toast.makeText(addnewschdropped.this, "Please enter dob", Toast.LENGTH_SHORT).show();

            }else if(nameofschoolattended.getText().toString().equals("")){
                Toast.makeText(addnewschdropped.this, "Please enter name of school attended", Toast.LENGTH_SHORT).show();

            }else if(highestformgradeclassattended.getText().toString().equals("")) {
                Toast.makeText(addnewschdropped.this, "Please enter class level", Toast.LENGTH_SHORT).show();

            }else if(birthreg.getText().toString().equals("")) {
                Toast.makeText(addnewschdropped.this, "Please enter birth reg no:", Toast.LENGTH_SHORT).show();

            }else if(country.getText().toString().equals("")) {
                Toast.makeText(addnewschdropped.this, "Please enter country", Toast.LENGTH_SHORT).show();

            }else if(caregivername.getText().toString().equals("")) {
                Toast.makeText(addnewschdropped.this, "Please enter caregiver name", Toast.LENGTH_SHORT).show();


            }else if(caregiverphone.getText().toString().equals("")) {
                Toast.makeText(addnewschdropped.this, "Please enter caregiver's Phone No", Toast.LENGTH_SHORT).show();

            }else if(placeofresidence.getText().toString().equals("")) {
                Toast.makeText(addnewschdropped.this, "Please enter residence", Toast.LENGTH_SHORT).show();

            }else if(reasonfordroppingoutofschool.getText().toString().equals("")) {
                Toast.makeText(addnewschdropped.this, "Please enter reason for dropping out", Toast.LENGTH_SHORT).show();

            }else if(lastgrademarksattained.getText().toString().equals("")) {
                Toast.makeText(addnewschdropped.this, "Please enter last grade attained", Toast.LENGTH_SHORT).show();

            }else if(caregiverid.getText().toString().equals("")) {
                Toast.makeText(addnewschdropped.this, "Please enter caregiver ID no:", Toast.LENGTH_SHORT).show();
            }else if(cstatement.getText().toString().equals("")) {
                Toast.makeText(addnewschdropped.this, "Please enter case statement", Toast.LENGTH_SHORT).show();
                ...
                ref.get().addOnSuccessListener((DocumentSnapshot documentSnapshot) -> {
                    ...
                    {
                        Toast.makeText(addnewschdropped.this, "Sorry,this case exists", Toast.LENGTH_SHORT).show();
                    } else {
                        Map<String, Object> reg_entry = new HashMap<>();
                        reg_entry.put("name",fullname.getText().toString());
                        reg_entry.put("dob", dateofbirth.getText().toString());
                        reg_entry.put("school attended", nameofschoolattended.getText().toString());
                        reg_entry.put("class level", highestformgradeclassattended.getText().toString());
                        reg_entry.put("residence", placeofresidence.getText().toString());
                        reg_entry.put("reason for dropping", reasonfordroppingoutofschool.getText().toString());
                        reg_entry.put("grade attained", lastgrademarksattained.getText().toString());
...
//                              String myId = ref.getId();
                        firebaseFirestore.collection("schooldropped")
                                .add(reg_entry)
...
//                                        Toast.makeText(addnewdefiledcase.this, " Case Successfully registered", Toast.LENGTH_LONG).show();
                                        Intent intent= new Intent(addnewschdropped.this,AdminNavActivity.class);
