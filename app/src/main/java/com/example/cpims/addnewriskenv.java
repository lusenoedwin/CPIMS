...
public class addnewriskenv extends AppCompatActivity {
    Spinner typeofoffence,sex,tribe,religion,subcounty,ward,relationship;String text = "";
    EditText fullname, dateofbirth,placeofresidence,birthreg,country,caregivername,caregiverphone,cstatement,caregiverid;
    Button regriskenvcase;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_addnewriskenv);
        ...
        regriskenvcase = findViewById(R.id.regriskenvcase);

        final FirebaseFirestore firebaseFirestore;
        final DocumentReference ref;
        firebaseFirestore = FirebaseFirestore.getInstance();
        ref = firebaseFirestore.collection("riskenv").document();


        regriskenvcase.setOnClickListener((View view) -> {
            if (fullname.getText().toString().equals("")) {
                Toast.makeText(addnewriskenv.this, "Please enter  full names", Toast.LENGTH_SHORT).show();

            } else if (dateofbirth.getText().toString().equals("")) {
                Toast.makeText(addnewriskenv.this, "Please enter dob", Toast.LENGTH_SHORT).show();

            } else if (birthreg.getText().toString().equals("")) {
                Toast.makeText(addnewriskenv.this, "Please enter birth reg no:", Toast.LENGTH_SHORT).show();

            } else if (country.getText().toString().equals("")) {
                Toast.makeText(addnewriskenv.this, "Please enter country", Toast.LENGTH_SHORT).show();

            } else if (placeofresidence.getText().toString().equals("")) {
                Toast.makeText(addnewriskenv.this, "Please enter place of residence ", Toast.LENGTH_SHORT).show();

            } else if (caregivername.getText().toString().equals("")) {
                Toast.makeText(addnewriskenv.this, "Please enter caregiver name", Toast.LENGTH_SHORT).show();

            } else if (caregiverphone.getText().toString().equals("")) {
                Toast.makeText(addnewriskenv.this, "Please enter caregiver phone", Toast.LENGTH_SHORT).show();
            } else if (caregiverid.getText().toString().equals("")) {
                Toast.makeText(addnewriskenv.this, "Please enter caregiver ID no:", Toast.LENGTH_SHORT).show();
            } else if (cstatement.getText().toString().equals("")) {
                Toast.makeText(addnewriskenv.this, "Please enter case statement", Toast.LENGTH_SHORT).show();
                ...
                ref.get().addOnSuccessListener((DocumentSnapshot documentSnapshot) -> {
                    ...
                    if (documentSnapshot.exists()) {
                        Toast.makeText(addnewriskenv.this, "Sorry,this case exists", Toast.LENGTH_SHORT).show();
                    } else {
...
//                              String myId = ref.getId();
                        firebaseFirestore.collection("riskenv")
                                .add(reg_entry)
                                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                    ...
                                    public void onSuccess(DocumentReference documentReference) {
                                        ...
                                        Intent intent = new Intent(addnewriskenv.this, AdminNavActivity.class);
