...
public class addnewlabour extends AppCompatActivity {
    ...
    Button regchildlabourcase;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_addnewlabour);
       ...
       cstatement=findViewById(R.id.cstatement);
        regchildlabourcase=findViewById(R.id.regchildlabourcase);

        final FirebaseFirestore firebaseFirestore;
        final DocumentReference ref;
        firebaseFirestore = FirebaseFirestore.getInstance();
        ref = firebaseFirestore.collection("childlabour").document();





        regchildlabourcase.setOnClickListener((View view) -> {
            if(childname.getText().toString().equals("")) {
                Toast.makeText(addnewlabour.this, "Please enter  full names", Toast.LENGTH_SHORT).show();

            }else if(dob.getText().toString().equals("")) {
                Toast.makeText(addnewlabour.this, "Please enter dob", Toast.LENGTH_SHORT).show();

            }else if(caregiverid.getText().toString().equals("")){
                Toast.makeText(addnewlabour.this, "Please enter father name", Toast.LENGTH_SHORT).show();

            }else if(residence.getText().toString().equals("")) {
                Toast.makeText(addnewlabour.this, "Please enter place of residence ", Toast.LENGTH_SHORT).show();

            }else if(birthreg.getText().toString().equals("")) {
                Toast.makeText(addnewlabour.this, "Please enter Birth Reg No", Toast.LENGTH_SHORT).show();
            }else if(caregivername.getText().toString().equals("")) {
                Toast.makeText(addnewlabour.this, "Please enter caregiver name", Toast.LENGTH_SHORT).show();
            }else if(caregiverphone.getText().toString().equals("")) {
                Toast.makeText(addnewlabour.this, "Please enter caregiver phone", Toast.LENGTH_SHORT).show();
            }else if(cstatement.getText().toString().equals("")) {
                Toast.makeText(addnewlabour.this, "Please enter case statement", Toast.LENGTH_SHORT).show();

            }else if(country.getText().toString().equals("")) {
                Toast.makeText(addnewlabour.this, "Please enter country of origin", Toast.LENGTH_SHORT).show();
                ...
                ref.get().addOnSuccessListener((DocumentSnapshot documentSnapshot) -> {
                    ...
                    {
                        Toast.makeText(addnewlabour.this, "Sorry,this case exists", Toast.LENGTH_SHORT).show();
                    } else {
                        ...
                        reg_entry.put("caregiver", caregivername.getText().toString());
                        reg_entry.put("caregiver tell", caregiverphone.getText().toString());
...
//                              String myId = ref.getId();
                        firebaseFirestore.collection("childlabour")
                                .add(reg_entry)
                                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                    ...
                                    public void onSuccess(DocumentReference documentReference) {
                                        ...
                                        Intent intent= new Intent(addnewlabour.this,AdminNavActivity.class);
