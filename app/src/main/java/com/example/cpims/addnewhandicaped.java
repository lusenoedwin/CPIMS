...
public class addnewhandicaped extends AppCompatActivity {
    ...
    Button regnewhandicappedcase;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_addnewhandicaped);
        ...
        relationship=findViewById(R.id.relationship);
            ...
            regnewhandicappedcase=findViewById(R.id.regnewhandicappedcase);

            final FirebaseFirestore firebaseFirestore;
            final DocumentReference ref;
            firebaseFirestore = FirebaseFirestore.getInstance();
            ref = firebaseFirestore.collection("handicapped").document();





            regnewhandicappedcase.setOnClickListener((View view) -> {
                if(fullname.getText().toString().equals("")) {
                    Toast.makeText(addnewhandicaped.this, "Please enter  full names", Toast.LENGTH_SHORT).show();

                }else if(dateofbirth.getText().toString().equals("")) {
                    Toast.makeText(addnewhandicaped.this, "Please enter dob", Toast.LENGTH_SHORT).show();

                }else if(birthreg.getText().toString().equals("")){
                    Toast.makeText(addnewhandicaped.this, "Please enter birth reg no:", Toast.LENGTH_SHORT).show();

                }else if(country.getText().toString().equals("")) {
                    Toast.makeText(addnewhandicaped.this, "Please enter country", Toast.LENGTH_SHORT).show();

                }else if(placeofresidence.getText().toString().equals("")) {
                    Toast.makeText(addnewhandicaped.this, "Please enter place of residence ", Toast.LENGTH_SHORT).show();

                }else if(caregivername.getText().toString().equals("")) {
                    Toast.makeText(addnewhandicaped.this, "Please enter caregiver name", Toast.LENGTH_SHORT).show();

                }else if(caregiverid.getText().toString().equals("")) {
                    Toast.makeText(addnewhandicaped.this, "Please enter caregiver ID", Toast.LENGTH_SHORT).show();
                }else if(cstatement.getText().toString().equals("")) {
                    Toast.makeText(addnewhandicaped.this, "Please enter case statement", Toast.LENGTH_SHORT).show();
                    ...
                    ref.get().addOnSuccessListener((DocumentSnapshot documentSnapshot) -> {
                        ...
                        {
                            Toast.makeText(addnewhandicaped.this, "Sorry,this case exists", Toast.LENGTH_SHORT).show();
                        } else {
...
//                              String myId = ref.getId();
                            firebaseFirestore.collection("handicapped")
                                    .add(reg_entry)
                                    .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                        ...
                                        public void onSuccess(DocumentReference documentReference) {
                                            ...
                                            Intent intent= new Intent(addnewhandicaped.this,AdminNavActivity.class);
