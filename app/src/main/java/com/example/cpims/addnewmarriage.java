...
public class addnewmarriage extends AppCompatActivity {
    Spinner sex,tribe,religion,subcounty,ward,relationship;String text = "";
    EditText fullname, dateofbirth, spousename, spousedateofbirth, placeofresidence,birthreg,country,caregivername,caregiverphone,cstatement,caregiverid;
    Button regnewchildmarriagecase;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_addnewmarriage);
        ...
        spousename = findViewById(R.id.sname);
        spousedateofbirth = findViewById(R.id.sdob);
        ...
        regnewchildmarriagecase=findViewById(R.id.regnewchildmarriagecase);

        final FirebaseFirestore firebaseFirestore;
        final DocumentReference ref;
        firebaseFirestore = FirebaseFirestore.getInstance();
        ref = firebaseFirestore.collection("childmarriage").document();





        regnewchildmarriagecase.setOnClickListener((View view) -> {
            if(fullname.getText().toString().equals("")) {
                Toast.makeText(addnewmarriage.this, "Please enter  full names", Toast.LENGTH_SHORT).show();

            }else if(dateofbirth.getText().toString().equals("")) {
                Toast.makeText(addnewmarriage.this, "Please enter dob", Toast.LENGTH_SHORT).show();

            }else if(spousename.getText().toString().equals("")){
                Toast.makeText(addnewmarriage.this, "Please enter spouse name", Toast.LENGTH_SHORT).show();

            }else if(spousedateofbirth.getText().toString().equals("")) {
                Toast.makeText(addnewmarriage.this, "Please enter spouse date of birth", Toast.LENGTH_SHORT).show();

            }else if(placeofresidence.getText().toString().equals("")) {
                Toast.makeText(addnewmarriage.this, "Please enter place of residence ", Toast.LENGTH_SHORT).show();
            }else if(birthreg.getText().toString().equals("")) {
                Toast.makeText(addnewmarriage.this, "Please enter birth reg no: ", Toast.LENGTH_SHORT).show();
            }else if(country.getText().toString().equals("")) {
                Toast.makeText(addnewmarriage.this, "Please enter country ", Toast.LENGTH_SHORT).show();
            }else if(caregivername.getText().toString().equals("")) {
                Toast.makeText(addnewmarriage.this, "Please enter caregiver name ", Toast.LENGTH_SHORT).show();
            }else if(caregiverphone.getText().toString().equals("")) {
                Toast.makeText(addnewmarriage.this, "Please enter caregiver phone ", Toast.LENGTH_SHORT).show();
            }else if(caregiverid.getText().toString().equals("")) {
                Toast.makeText(addnewmarriage.this, "Please enter caregiver ID no: ", Toast.LENGTH_SHORT).show();
            }else if(cstatement.getText().toString().equals("")) {
                Toast.makeText(addnewmarriage.this, "Please enter case statement ", Toast.LENGTH_SHORT).show();
                ...
                ref.get().addOnSuccessListener((DocumentSnapshot documentSnapshot) -> {
                    ...
                    {
                        Toast.makeText(addnewmarriage.this, "Sorry,this case exists", Toast.LENGTH_SHORT).show();
                    } else {
                        Map<String, Object> reg_entry = new HashMap<>();
                        reg_entry.put("childname",fullname.getText().toString());
                        reg_entry.put("dob", dateofbirth.getText().toString());
                        reg_entry.put("sname", spousename.getText().toString());
                        reg_entry.put("sdob", spousedateofbirth.getText().toString());
...
//                              String myId = ref.getId();
                        firebaseFirestore.collection("childmarriage")
                                .add(reg_entry)
                                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                    ...
                                    public void onSuccess(DocumentReference documentReference) {
                                        ...
                                        Intent intent= new Intent(addnewmarriage.this,AdminNavActivity.class);
