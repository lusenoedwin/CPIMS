...
public class addnewchilddispute extends AppCompatActivity {
    ...
    Button regchilddispute;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_addnewchilddispute);
        ...
        regchilddispute = findViewById(R.id.regchilddispute);

        final FirebaseFirestore firebaseFirestore;
        final DocumentReference ref;
        firebaseFirestore = FirebaseFirestore.getInstance();
        ref = firebaseFirestore.collection("childdispute").document();





        regchilddispute.setOnClickListener((View view) -> {
            if(childname.getText().toString().equals("")) {
                Toast.makeText(addnewchilddispute.this, "Please enter  full names", Toast.LENGTH_SHORT).show();

            }else if(dob.getText().toString().equals("")) {
                Toast.makeText(addnewchilddispute.this, "Please enter dob", Toast.LENGTH_SHORT).show();

            }else if(birthreg.getText().toString().equals("")){
                Toast.makeText(addnewchilddispute.this, "Please enter birth reg no:", Toast.LENGTH_SHORT).show();

            }else if(country.getText().toString().equals("")) {
                Toast.makeText(addnewchilddispute.this, "Please enter Country of origin", Toast.LENGTH_SHORT).show();

            }else if(residence.getText().toString().equals("")) {
                Toast.makeText(addnewchilddispute.this, "Please enter place of residence", Toast.LENGTH_SHORT).show();

            }else if(caregivername.getText().toString().equals("")) {
                Toast.makeText(addnewchilddispute.this, "Please enter caregiver name", Toast.LENGTH_SHORT).show();

            }else if(caregiverphone.getText().toString().equals("")) {
                Toast.makeText(addnewchilddispute.this, "Please enter caregiver phone", Toast.LENGTH_SHORT).show();
            }else if(cstatement.getText().toString().equals("")) {
                Toast.makeText(addnewchilddispute.this, "Please enter case statement", Toast.LENGTH_SHORT).show();
            }else if(caregiverid.getText().toString().equals("")) {
                Toast.makeText(addnewchilddispute.this, "Please enter caregiver ID", Toast.LENGTH_SHORT).show();
                ...
                ref.get().addOnSuccessListener((DocumentSnapshot documentSnapshot) -> {
                    ...
                    {
                        Toast.makeText(addnewchilddispute.this, "Sorry,this case exists", Toast.LENGTH_SHORT).show();
                    } else {
...
//                              String myId = ref.getId();
                        firebaseFirestore.collection("childdispute")
                                .add(reg_entry)
...
//                                        Toast.makeText(addnewdefiledcase.this, " Case Successfully registered", Toast.LENGTH_LONG).show();
                                        Intent intent= new Intent(addnewchilddispute.this,AdminNavActivity.class);
